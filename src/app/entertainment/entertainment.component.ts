...
export class EntertainmentComponent implements OnInit {
  ...
  mArticles: Array<any>;
  mSources: Array<any>;
  constructor(private newsapi: NewsApiService, private router: Router, private activatedRoute: ActivatedRoute,
  ...
  ngOnInit() {
    //load articles
    this.newsapi.initArticles("entertainment").subscribe(data => this.mArticles = data['articles']);
    //load news sources
